 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: info.h,v 1.3 1999/10/12 13:00:57 cphipps Exp $
 *
...
typedef enum {
  ...
  Action_A_FirePistol,
  Action_A_Light1,
  Action_A_FireShotgun,
  Action_A_Light2,
  Action_A_FireShotgun2,
  Action_A_CheckReload,
  Action_A_OpenShotgun2,
  Action_A_LoadShotgun2,
  Action_A_CloseShotgun2,
  Action_A_FireCGun,
  Action_A_GunFlash,
  Action_A_FireMissile,
  Action_A_Saw,
  Action_A_FirePlasma,
  Action_A_BFGsound,
  Action_A_FireBFG,
  ...
  Action_A_StartFire,
  Action_A_Fire,
  Action_A_FireCrackle,
  Action_A_Tracer,
  Action_A_SkelWhoosh,
  Action_A_SkelFist,
  Action_A_SkelMissile,
  Action_A_FatRaise,
  Action_A_FatAttack1,
  Action_A_FatAttack2,
  Action_A_FatAttack3,
  ...
  Action_A_CPosAttack,
  Action_A_CPosRefire,
  Action_A_TroopAttack,
  Action_A_SargAttack,
  Action_A_HeadAttack,
  Action_A_BruisAttack,
  Action_A_SkullAttack,
  Action_A_Metal,
  Action_A_SpidRefire,
  Action_A_BabyMetal,
  Action_A_BspiAttack,
  Action_A_Hoof,
  Action_A_CyberAttack,
  Action_A_PainAttack,
  Action_A_PainDie,
  Action_A_KeenDie,
  Action_A_BrainPain,
  Action_A_BrainScream,
  Action_A_BrainDie,
  Action_A_BrainAwake,
  Action_A_BrainSpit,
  Action_A_SpawnSound,
  Action_A_SpawnFly,
  Action_A_BrainExplode,
  Action_A_Detonate,
  Action_A_Mushroom,
  Action_A_Die,
  Action_A_Spawn,
...
typedef struct
{
  ...
  action_t    action;        /* function for action if any  */
